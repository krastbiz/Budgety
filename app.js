...
var budgetController = (function() {
    ...
    return {
        addItem: function(type, descr, val) {
            ...
            //Create new ID based on the las element ID + 1
        ...
        getPercentages: function() {
            var allPercemtages = data.allItems.exp.map(function(cur){
                return cur.getPercentage();
            });
            
            return allPercemtages;
        },
...
var UIController = (function() {
    ...
    return {
        ...
        displayBudget: function(obj) {
            ...
            document.querySelector(DOMstrings.budgetLagel).textContent = formatNumber(obj.budget, type);
...
var controller = (function(budgetCtrl, UICtrl) {  
    ...
    var ctrlAddItem = function() {
        ...
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            UICtrl.addListIten(newItem, input.type);
            UICtrl.clearFields();
